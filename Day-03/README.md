...
aws_s3_bucket -> resource type (The provider name serves as the prefix in the resource type.)
web_bucket -> The logical name for this resource block will be used to reference it in other resource blocks when required.
bucket, tags -> Supported arguments.
